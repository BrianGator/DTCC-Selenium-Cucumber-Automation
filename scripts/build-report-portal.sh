    ...
    <section class="card">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><a href="index.html">surefire/index.html</a></td><td>This friendly summary page.</td></tr>
          <tr><td><a href="testng-results.xml">testng-results.xml</a></td><td>Raw TestNG XML with pass/fail/skip details.</td></tr>
          <tr><td><a href="surefire-reports.zip">raw artifact</a></td><td>If a browser cannot list the folder, use the GitHub Actions raw-test-results artifact.</td></tr>
        </tbody>
      </table>
    </section>
    <section class="card">
