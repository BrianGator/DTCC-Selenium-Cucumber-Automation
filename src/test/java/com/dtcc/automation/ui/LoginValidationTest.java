...
public class LoginValidationTest extends UiTestBase {
    @Test(description = "Valid login displays the catalogue area in the local mock app")
    public void validUserCanLoginToMockOrderApplication() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("Catalogue"), "Catalogue should be available after login.");
    }
